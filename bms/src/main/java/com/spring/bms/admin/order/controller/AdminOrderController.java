package com.spring.bms.admin.order.controller;
...
import com.spring.bms.admin.order.service.AdminOrderService;
...
private AdminOrderService adminOrderService;
	...
	public void orderExcelExport(HttpServletResponse response , @RequestParam Map<String, String> dateMap) throws Exception {
		...
		for (Map<String,Object> orderMap :  adminOrderService.getOrderList()) {
	        ...
	        cell = row.createCell(5);
	        cell.setCellStyle(bodyStyle);
	        cell.setCellValue((String)orderMap.get("goodsGroup"));
	        cell = row.createCell(6);
	        cell.setCellStyle(bodyStyle);
	        cell.setCellValue((String)orderMap.get("goodsCategory"));
	        cell = row.createCell(7);
	        cell.setCellStyle(bodyStyle);
