                                        ...
                                        <div class="card-body">
                                            <div class="shop__sidebar__categories">
                                                <ul class="nice-scroll">
                                                    ...
                                                    <li><a href="${contextPath }/goods/mensGoodsList?sort=all&goodsGroup=mens&goodsCategory=coats&jackets">Coats&Jackets</a></li>
                                                    <li><a href="${contextPath }/goods/mensGoodsList?sort=all&goodsGroup=mens&goodsCategory=sweaters">Sweaters </a></li>
                                                    <li><a href="${contextPath }/goods/mensGoodsList?sort=all&goodsGroup=mens&goodsCategory=shirts">Shirts </a></li>
                                                    <li><a href="${contextPath }/goods/mensGoodsList?sort=all&goodsGroup=mens&goodsCategory=tshirts">T-Shirts </a></li>
                                                    <li><a href="${contextPath }/goods/mensGoodsList?sort=all&goodsGroup=mens&goodsCategory=pants">Pants </a></li>
                                                    <li><a href="${contextPath }/goods/mensGoodsList?sort=all&goodsGroup=mens&goodsCategory=shoes">Shoes </a></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6">
                                <div class="shop__product__option__right">
                                    ...
                                    <select name="sort">
                                		...
                                		<option value="${contextPath }/goods/searchGoods?method=keyword&keyword=discountRate">할인률높은순</option>
                                    </select>
                                </div>
                            </div>
                        </div>
