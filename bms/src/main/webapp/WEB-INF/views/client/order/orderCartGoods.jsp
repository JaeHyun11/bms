                   ...
                   <div class="col-lg-4 col-md-6">
                       <div class="checkout__order">
                           ...
                           <ul class="checkout__total__products">
                               ...
                               <li>상품 금액 <span id="viewPaymentAmt"></span></li>
                           </ul>
                           
                           <ul class="checkout__total__all">
                               <li>배송비 <spanid="totalDeliveryPrice"></span></li>
                               <li>포인트 <span><c:set var="point" value="0"/>
                               		<c:forEach var="goodsDto" items="${goodsList }" varStatus="i">
                                    <c:set var="point" value="${point + goodsDto.point }"/>P 적립</span></li>
