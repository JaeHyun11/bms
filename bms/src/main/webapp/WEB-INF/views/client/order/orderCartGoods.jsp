            ...
            <form action="${contextPath }/order/orderCartGoods" method="post" class="checkout__form">
                <div class="row">
                   <div class="col-lg-8 col-md-6">
                       <h6 class="checkout__title">내 주문정보</h6>
                       <div class="row">
                           <div class="col-lg-6">
                   ...
                   <div class="col-lg-4 col-md-6">
                       <div class="checkout__order">
                           ...
                           <ul class="checkout__total__products">
                               ...
                               <li>
                               	   ${i.index + 1}.&nbsp; ${goodsDto.goodsNm }&emsp;&emsp;
                               	   <span id="qty${i.index }"></span>&emsp;&emsp;&emsp;<br>
                           ...
                           <ul class="checkout__total__all">
                               ...
                               <li>포인트 <span id="totalPoint"></span></li>
                               
                           	   <li>합계 <span id="viewPaymentAmt"/></span></li>
                           </ul>
